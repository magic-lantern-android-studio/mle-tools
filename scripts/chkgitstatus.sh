...
for i in core-math core-runtime parts-base parts-mrefs parts-roles parts-props parts-stages parts-sets parts-actors titles-imagetest titles-modeltest titles-hellocube titles-cubetest;
do
